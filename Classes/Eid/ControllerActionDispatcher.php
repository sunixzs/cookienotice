...
namespace MAB\Cookienotice\Eid;
...
class ControllerActionDispatcher
{
     ...
     *
     * @return \MAB\CookieNotice\Eid\ControllerActionDispatcher
     */
    ...
    public function initCallArguments()
    {
        ...
        return $this->setVendorName($this->requestArguments[ 'vendorName' ])->setExtensionName($this->requestArguments[ 'extensionName' ])->setPluginName(
                $this->requestArguments[ 'pluginName' ]
        )->setControllerName($this->requestArguments[ 'controllerName' ])->setActionName($this->requestArguments[ 'actionName' ])->setFormatName(
                $this->requestArguments[ 'formatName' ]
